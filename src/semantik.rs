...
impl LingkunganTipe {
    pub fn baru() -> Self {
        ...
        env_sistem.borrow_mut().simpan_fungsi("strlen".to_string(), vec!["teks".to_string()], "bilangan".to_string(), true);
        ...
        env_matematika.borrow_mut().simpan_fungsi("absolut".to_string(), vec!["desimal".to_string()], "desimal".to_string(), true);
        env_matematika.borrow_mut().simpan_fungsi("eksponen".to_string(), vec!["desimal".to_string()], "desimal".to_string(), true);
        env_matematika.borrow_mut().simpan_fungsi("logaritma_alami".to_string(), vec!["desimal".to_string()], "desimal".to_string(), true);
        env_matematika.borrow_mut().simpan_fungsi("pembulatan".to_string(), vec!["desimal".to_string()], "bilangan".to_string(), true);
        env_matematika.borrow_mut().simpan_fungsi("acak".to_string(), vec![], "desimal".to_string(), true);
        env_matematika.borrow_mut().simpan_fungsi("maksimum".to_string(), vec!["bilangan".to_string(), "bilangan".to_string()], "bilangan".to_string(), true);
        env_matematika.borrow_mut().simpan_fungsi("minimum".to_string(), vec!["bilangan".to_string(), "bilangan".to_string()], "bilangan".to_string(), true);
        env.simpan_modul("Matematika".to_string(), env_matematika, true);
        
        // --- Modul Koleksi (HashMap, HashSet, Daftar) ---
        let env_koleksi = Rc::new(RefCell::new(LingkunganTipe::kosong()));
        // Kamus (HashMap)
        env_koleksi.borrow_mut().simpan_fungsi("kamus_baru".to_string(), vec![], "kamus".to_string(), true);
        env_koleksi.borrow_mut().simpan_fungsi("simpan".to_string(), vec!["kamus".to_string(), "teks".to_string(), "bilangan".to_string()], "kosong".to_string(), true);
        env_koleksi.borrow_mut().simpan_fungsi("ambil".to_string(), vec!["kamus".to_string(), "teks".to_string()], "bilangan".to_string(), true);
        env_koleksi.borrow_mut().simpan_fungsi("hapus".to_string(), vec!["kamus".to_string(), "teks".to_string()], "kosong".to_string(), true);
        env_koleksi.borrow_mut().simpan_fungsi("ada".to_string(), vec!["kamus".to_string(), "teks".to_string()], "logika".to_string(), true);
        env_koleksi.borrow_mut().simpan_fungsi("panjang_kamus".to_string(), vec!["kamus".to_string()], "bilangan".to_string(), true);
        // Kumpulan (HashSet)
        env_koleksi.borrow_mut().simpan_fungsi("set_baru".to_string(), vec![], "kumpulan".to_string(), true);
        env_koleksi.borrow_mut().simpan_fungsi("tambah_set".to_string(), vec!["kumpulan".to_string(), "bilangan".to_string()], "kosong".to_string(), true);
        env_koleksi.borrow_mut().simpan_fungsi("hapus_set".to_string(), vec!["kumpulan".to_string(), "bilangan".to_string()], "kosong".to_string(), true);
        env_koleksi.borrow_mut().simpan_fungsi("ada_set".to_string(), vec!["kumpulan".to_string(), "bilangan".to_string()], "logika".to_string(), true);
        env_koleksi.borrow_mut().simpan_fungsi("panjang_set".to_string(), vec!["kumpulan".to_string()], "bilangan".to_string(), true);
        env.simpan_modul("Koleksi".to_string(), env_koleksi, true);
        
        // --- Modul Teks (Manipulasi String) ---
        let env_teks = Rc::new(RefCell::new(LingkunganTipe::kosong()));
        env_teks.borrow_mut().simpan_fungsi("panjang".to_string(), vec!["teks".to_string()], "bilangan".to_string(), true);
        env_teks.borrow_mut().simpan_fungsi("gabung".to_string(), vec!["teks".to_string(), "teks".to_string()], "teks".to_string(), true);
        env_teks.borrow_mut().simpan_fungsi("potong".to_string(), vec!["teks".to_string(), "bilangan".to_string(), "bilangan".to_string()], "teks".to_string(), true);
        env_teks.borrow_mut().simpan_fungsi("ubah_besar".to_string(), vec!["teks".to_string()], "teks".to_string(), true);
        env_teks.borrow_mut().simpan_fungsi("ubah_kecil".to_string(), vec!["teks".to_string()], "teks".to_string(), true);
        env_teks.borrow_mut().simpan_fungsi("ganti".to_string(), vec!["teks".to_string(), "teks".to_string(), "teks".to_string()], "teks".to_string(), true);
        env_teks.borrow_mut().simpan_fungsi("berisi".to_string(), vec!["teks".to_string(), "teks".to_string()], "logika".to_string(), true);
        env_teks.borrow_mut().simpan_fungsi("kosong".to_string(), vec!["teks".to_string()], "logika".to_string(), true);
        env_teks.borrow_mut().simpan_fungsi("trim".to_string(), vec!["teks".to_string()], "teks".to_string(), true);
        env_teks.borrow_mut().simpan_fungsi("karakter_ke".to_string(), vec!["teks".to_string(), "bilangan".to_string()], "karakter".to_string(), true);
        env.simpan_modul("Teks".to_string(), env_teks, true);
        
        // --- Modul Konversi (Konversi Tipe) ---
        let env_konversi = Rc::new(RefCell::new(LingkunganTipe::kosong()));
        env_konversi.borrow_mut().simpan_fungsi("teks_ke_bilangan".to_string(), vec!["teks".to_string()], "bilangan".to_string(), true);
        env_konversi.borrow_mut().simpan_fungsi("bilangan_ke_teks".to_string(), vec!["bilangan".to_string()], "teks".to_string(), true);
        env_konversi.borrow_mut().simpan_fungsi("teks_ke_desimal".to_string(), vec!["teks".to_string()], "desimal".to_string(), true);
        env_konversi.borrow_mut().simpan_fungsi("desimal_ke_teks".to_string(), vec!["desimal".to_string()], "teks".to_string(), true);
        env_konversi.borrow_mut().simpan_fungsi("karakter_ke_teks".to_string(), vec!["karakter".to_string()], "teks".to_string(), true);
        env_konversi.borrow_mut().simpan_fungsi("teks_ke_karakter".to_string(), vec!["teks".to_string()], "karakter".to_string(), true);
        env_konversi.borrow_mut().simpan_fungsi("bilangan_ke_karakter".to_string(), vec!["bilangan".to_string()], "karakter".to_string(), true);
        env_konversi.borrow_mut().simpan_fungsi("karakter_ke_bilangan".to_string(), vec!["karakter".to_string()], "bilangan".to_string(), true);
        env.simpan_modul("Konversi".to_string(), env_konversi, true);
